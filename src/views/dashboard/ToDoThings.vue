  ...
  <div class="wallet-div">
    ...
    <div class="row text-center" v-show="!toDoThingsViewDisabled">
      <div class="col like-to-do-div" @click="comingSoon">
        <div>
          <img class="like-to-do-logo" :src="'/static/like-to-do/transfer.png'" :alt="$t('token.name')"/>
        </div>
      ...
      <div class="col like-to-do-div" @click="comingSoon">
        <div>
          <img class="like-to-do-logo" :src="'/static/like-to-do/track.png'" :alt="$t('token.name')"/>
        </div>
